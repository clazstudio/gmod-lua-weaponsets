...
add("weaponsets.weaponsinvehicle",      "Allow weapons in vehicle")
add("weaponsets.weaponsinvehicle.desc", "Whether the player is allowed to use his weapons in a vehicle or not.")
...
add("weaponsets.speed",             "Normal walk speed")
add("weaponsets.speed.desc",        "Player's normal WASD walking speed.")
add("weaponsets.walkspeed",         "Slow walk speed")
add("weaponsets.walkspeed.desc",    "Player's slow walking speed (+walk, Alt key by default)")
add("weaponsets.climbspeed",        "Ladder climbing speed")
add("weaponsets.climbspeed.desc",   "Player's ladder climbing speed")

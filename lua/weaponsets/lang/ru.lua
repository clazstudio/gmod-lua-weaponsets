...
add("weaponsets.infiniteammo",          "Бесконечные патроны")
...
add("weaponsets.weaponsinvehicle",      "Разрешить оружие в транспорте")
add("weaponsets.weaponsinvehicle.desc", "Сможет ли игрок использовать оружие, находясь в транспорте")
...
add("weaponsets.model.desc",            "Модель должна быть заранее закеширована (precache)")
...
add("weaponsets.jump.desc",         "Скорость, которая будет применена игроку при прыжке")
...
add("weaponsets.timescale.desc",    "Позволяет замедля или ускорять все движения определённого игрока, похоже на host_timescale")
add("weaponsets.enablewalk",        "Разрешить медленную ходьбу?")
add("weaponsets.enablewalk.desc",   "Позволяет или запрещает медленно ходить +walk (по умолчанию клавиша Alt)")
add("weaponsets.speed",             "Скорость ходьбы (обычная)")
add("weaponsets.speed.desc",        "Скорость обычной ходьбы игрока WASD.")
add("weaponsets.walkspeed",         "Скорость медленной ходьбы")
add("weaponsets.walkspeed.desc",    "Скорость медленной (бесшумной) ходьбы (+walk, По умолчанию на клавише Alt)")
add("weaponsets.climbspeed",        "Скорость на лестнице")
add("weaponsets.climbspeed.desc",   "Скорость карабканья по вертикальной лестнице (не ступеньки)")
add("weaponsets.runspeed",          "Скорость бега")
add("weaponsets.runspeed.desc",     "Скорость бега (спринта) игрока. +speed Чтобы запретить игроку бегать, установите равным скорости ходьбы")
...
add("weaponsets.unduckspeed.desc",  "Как быстро игрок встаёт из положения сидя.")
...
add("weaponsets.allowflashlight",       "Разрешить фонарик?")
...
add("weaponsets.maxhealth.desc",        "Максимальное значение до которого можно восстановить здоровье.")
